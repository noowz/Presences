...
let strings: Awaited<ReturnType<typeof getStrings>>,
  ...
  playingVidClose: HTMLElement | null | undefined
      ...
      switch (true) {
        ...
        case pathname.includes('/videos/'): {
          ...
          if (video?.paused) {
            ...
            [presenceData.startTimestamp, presenceData.endTimestamp] = presence.getTimestampsfromMedia(video as HTMLMediaElement)
          }
    ...
    case pathname.includes('/watch'): {
      ...
      switch (true) {
        case !!hrefReplaced.match(/watch\?v=\d{15}/g)?.[0]: {
          ...
          const playingVid = document.querySelector<HTMLVideoElement>('video')!
        ...
        case hrefReplaced === 'https://www.facebook.com/watch': {
          ...
          switch (true) {
            case cached?.element && !!cached?.id: {
              delete presenceData.startTimestamp
              playingVidClose = cached.element.closest<HTMLElement>(
            ...
            case !!playingVid?.getAttribute('src')
              ...
              playingVidClose = playingVid!.closest<HTMLElement>(
                'div[class="x78zum5 xdt5ytf"]',
              )
