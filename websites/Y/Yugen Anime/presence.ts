...
presence.on('UpdateData', async () => {
  ...
  const [showTimestamp, showButtons, newLang, privacy, showCovers] = await Promise.all([
  ...
  const discoverPage = document.querySelector(
